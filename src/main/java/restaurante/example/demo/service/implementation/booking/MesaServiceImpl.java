...
public class MesaServiceImpl implements IMesaService {
    ...
    private void updateEntityFromDto(MesaEntity mesaEntity, MesaDto MesaDto){
        mesaEntity.setCodigo(MesaDto.getCodigo());
        mesaEntity.setCapacidad(MesaDto.getCapacidad());
        mesaEntity.setEstado(MesaDto.getEstado());
        mesaEntity.setUbicacion(MesaDto.getUbicacion());
        mesaEntity.setDecorada(MesaDto.getDecorada());
        mesaEntity.setImagen(MesaDto.getImagen());
        mesaEntity.setRutaImagen(MesaDto.getRutaImagen());           
    }
}
